document.addEventListener('DOMContentLoaded', () => {
  ...
  {
  title: "واقعہ: حضرت نوح علیہ السلام کی کشتی",
  text: "جواب: حضرت نوح علیہ السلام اللہ تعالیٰ کے برگزیدہ نبی تھے۔ جب ان کی قوم بتوں کی پوجا کرنے لگی اور گناہوں میں ڈوب گئی تو اللہ تعالیٰ نے حضرت نوح علیہ السلام کو ان کی ہدایت کے لیے بھیجا۔ آپ نے اپنی قوم کو کئی سو سال تک اللہ کی طرف بلایا، مگر چند لوگوں کے سوا کسی نے ایمان قبول نہ کیا۔ قوم کے سرداروں نے آپ کا مذاق اُڑایا اور کہا کہ یہ تو ایک عام انسان ہے۔ پھر اللہ تعالیٰ نے حضرت نوح علیہ السلام کو حکم دیا کہ ایک بڑی کشتی بنائیں۔ جب وہ کشتی بنا رہے تھے تو لوگ ہنستے اور کہتے کہ پہاڑ پر کشتی بنا رہا ہے! مگر حضرت نوح علیہ السلام صبر کرتے رہے۔ جب اللہ کا حکم آیا تو زمین سے پانی اُبل پڑا اور آسمان سے بارش برسنے لگی۔ نوح علیہ السلام نے اپنے اہل ایمان ساتھیوں اور ہر جانور کے نر و مادہ جوڑے کشتی میں سوار کر لیے۔ پانی اتنا بڑھا کہ پہاڑ بھی ڈوب گئے۔ جو ایمان نہیں لائے، سب غرق ہوگئے۔ آخرکار طوفان تھم گیا اور کشتی پہاڑِ جودی پر ٹھہر گئی۔ حضرت نوح علیہ السلام اور ان کے ساتھیوں نے اللہ کا شکر ادا کیا۔ یہ واقعہ ہمیں صبر، ایمان اور اللہ پر یقین رکھنے کا سبق دیتا ہے۔"
    }
    ];   
